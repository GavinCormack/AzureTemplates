...
Write-Host "Configure Additional Domain Controller - (Part 1)"
Write-Host ""
Write-Host ""
...
Write-Host ""
Start-Sleep -s 1
Write-Host "2. Configure Domain & Configure Server to an Additional Domain Controller"
Write-Host ""
Start-Sleep -s 1
...
####################  2. CONFIGURE DOMAIN & CONFIGURE SERVER TO AN ADDITIONAL DOMAIN CONTROLLER  ####################
...
# Get Domain Information from DomainCSV
...
$primaryDC = $primaryDC + "." + $fullDomain
...
Write-Host "    Joining the AD Forest..."
